    ...
    return(
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <Link to="/profil" class="nav-item nav-link text-light ml-auto">My Profil</Link>
          </li>
          
        </ul>
        <a class="btn btn-light ml-auto" onClick={this.Logout} >Logout</a>
      </div>
  ...
  navUser = () => {
    return(
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <Link to="/Home" className="nav-item nav-link text-light mr-4">Home</Link>
          </li>
          <li className="nav-item">
    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow">
          <a className="navbar-brand font-weight-bold">ARYA SPORT CENTER</a>
